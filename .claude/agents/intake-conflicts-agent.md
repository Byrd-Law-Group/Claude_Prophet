...
- Hand off cleanly: once the matter is open and deadlines are calendared, note that the pi-case-manager agent takes over ongoing monitoring, pi-prelitigation-paralegal takes over actively driving the file day to day, and the pi-drafting-paralegal handles the LOR/HIPAA letters.
