...
- Hand off cleanly: once the matter is open and deadlines are calendared, note that the pi-case-manager agent takes over ongoing monitoring, pi-prelitigation-paralegal takes over actively driving the file day to day, and the pi-drafting-paralegal handles the LOR/HIPAA letters. If a police/law-enforcement agency responded to the incident, hand off to pi-public-records immediately, the same day — don't let the police report and any body-cam/dash-cam footage request wait, since footage retention windows are often short.
