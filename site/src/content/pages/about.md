...
we acquire. We would rather do a smaller number of properties well than move
quickly and leave problems behind us.

Just as important, we work **with** the county, not around it. Delinquent taxes
are a problem for owners, for neighbors, and for the community's tax base. When
those taxes get paid and a neglected property is repaired, everyone benefits.
That is the outcome we aim for on every acquisition.

## How we acquire property

We acquire property through a few well-established, public channels in
Montgomery County:

- **Montgomery County Sheriff tax foreclosure sales** — properties sold at
  auction after the county forecloses on unpaid property taxes.
- **Montgomery County Auditor forfeited land sales** — parcels that went
  unsold at foreclosure and were forfeited to the state, then offered again.
